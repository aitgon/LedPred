...
testthat::expect_true(all(obj$feature.ranking[c(1,2), 'FeatureName']==c('LHX2.output_1', 'Exex_SOLEXA_FBgn0041156')))
testthat::expect_true(obj$best.feature.nb==300)
...
testthat::expect_equal(as.numeric(scores)[1], 0.9998968, tolerance=1e-2)
testthat::expect_true(all(obj$feature.ranking[c(11,12), 'AvgRank']==c(79.2, 79.8)))
...
testthat::expect_true(all(obj$feature.ranking[c(1,2), 'FeatureName']==c('LHX2.output_1', 'Exex_SOLEXA_FBgn0041156')))
testthat::expect_true(all(obj$feature.ranking[c(11,12), 'AvgRank']==c(79.2, 79.8)))
testthat::expect_true(obj$feature.nb==300)
