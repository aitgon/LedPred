...
testthat::expect_equal(as.numeric(scoreData(x, model=model.obj))[1], 0.252, tolerance=1e-2)
})
...
testthat::expect_equal(as.numeric(scoreData(x, model=model.obj))[1], 0.0481, tolerance=1e-2)
})
