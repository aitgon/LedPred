...
testthat::expect_equal(as.numeric(scoreData(x, model=model.obj))[1], 0.943, tolerance=1e-2)
})
...
testthat::expect_equal(as.numeric(scoreData(x, model=model.obj))[1], 0.997, tolerance=1e-2)
})
